...
class PharmacyDatabaseServices {
  ...
  void addPharmacyReview(String pharmacyID, String reviewID, UserReview review) async {
  ...
  void addPharmacyOrder(String pharmacyID, String orderID, UserOrder order) async {
