...
import 'package:medifinder/pages/add_item.dart'; // Adjust import based on your project structure
...
class _DrugsState extends State<Drugs> {
  final UserDatabaseServices dbService = UserDatabaseServices();
